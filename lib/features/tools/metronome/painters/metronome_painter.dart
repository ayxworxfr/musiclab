...
class MetronomePainter extends CustomPainter {
    ...
    for (var i = 0; i < beatsPerMeasure; i++) {
      ...
      if (isActive) {
        final glowPaint = Paint()
          ..color = (isStrong ? theme.accentColor : theme.primaryColor)
  ...
  void _drawPendulum(Canvas canvas, Size size, Offset center) {
    ...
    canvas.drawCircle(bobCenter, bobRadius, Paint()..shader = bobGradient);
    ...
    // 支点
    final pivotGradient = ui.Gradient.radial(center - const Offset(2, 2), 12, [
